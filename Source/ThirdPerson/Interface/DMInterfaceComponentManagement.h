...
#include "DMInterfaceComponentManagement.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class UDMInterfaceComponentManagement : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class THIRDPERSON_API IDMInterfaceComponentManagement
{
	GENERATED_BODY()
...
template <class TComponent>
TComponent* IDMInterfaceComponentManagement::GetComponent()
{
...
template <class TComponent>
TComponent* IDMInterfaceComponentManagement::CreateComponent(EDMComponentType InComponentType, bool bInEnableTick /*= false*/)
{
	AActor* OwnerActor = Cast<AActor>(this);
	if (OwnerActor == nullptr)
		return nullptr;
