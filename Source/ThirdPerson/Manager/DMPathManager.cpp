...
{
	AddPath(EDMPath::UIPanel, "/Game/Blueprints/UI/Panel/");
	AddPath(EDMPath::UISlot, "/Game/Blueprints/UI/Slot/");
	AddPath(EDMPath::Preview, "/Game/Blueprints/PreviewStudio/");
	AddPath(EDMPath::Actor, "/Game/Blueprints/Actor/");
}
