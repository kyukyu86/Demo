...
#include "WRUIScrollBoxSlot.generated.h"

/** The Slot for the UScrollBox, contains the widget that are scrollable */
UCLASS()
class UWRUIScrollBoxSlot : public UPanelSlot
{
...
public:
	...
	void BuildSlot(TSharedRef<class WRUISScrollBox> ScrollBox);
